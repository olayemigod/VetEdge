...
class TestCoreEdgeAdapter(unittest.TestCase):
	...
	def test_filter_bootinfo_branding_overrides(self):
		...
		self.assertEqual(bootinfo.desktop_icons[0]["link_type"], "External")
		self.assertEqual(bootinfo.desktop_icons[0]["link"], "/desk/vetedge-executive-dashboard")
		...
		self.assertEqual(bootinfo.app_data[0]["route"], "/desk/vetedge-executive-dashboard")
