...
def test_legacy_reports_remain_non_sortable_while_stock_expiry_uses_server_sorting():
    registry = read("public/js/vetedge_report_provider_registry.js")
    ...
    assert 'fieldname: "expiry_date", label: "Expiry Date", fieldtype: "Date", sortable: true' in registry
