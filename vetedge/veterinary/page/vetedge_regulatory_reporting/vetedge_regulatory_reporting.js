		...
		const component = {
			...
			render() {
				const filterPanel = h("div", { class: "vetedge-regulatory-card" }, [
					...
					h("p", __("Regulatory exports use permission-aware Company and Branch scope plus the supplied NADIS workbook mappings. Validation never changes clinical, accounting or stock records.")),
				]);
