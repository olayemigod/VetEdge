...
app_include_css = [
	...
	"/assets/vetedge/css/vetedge_professional_ui.css?v=20260723-2",
]
app_include_js = [
...
has_permission = {
	...
	"Pet Grooming Appointment": "vetedge.services.permissions.has_veterinary_grooming_appointment_permission",
	"Pet Grooming Session": "vetedge.services.permissions.has_veterinary_grooming_session_permission",
